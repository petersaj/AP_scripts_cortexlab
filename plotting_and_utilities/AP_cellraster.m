...
if ~exist('templateDepths','var')
    templateDepths = evalin('base','templateDepths');
end
...
switch eventdata.Key
    ...
    case 'm'
        ...
        templateDepths = get(gui_data.unit_dots,'YData');
        gui_data.curr_unit = find(templateDepths >= multiunit_top & ...
            templateDepths <= multiunit_bottom);        
end
