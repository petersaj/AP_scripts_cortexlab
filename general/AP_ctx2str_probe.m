...
probe_color = lines(length(animals));
...
for curr_animal = 1:length(animals)
    ...
    for curr_day = 1:length(experiments)
        ...
        title('Click probe entry and higher point');
        probe_wf = ginput(2);
        close(h)
        ...
        % Plot current probe vector
        line(ccf_axes,probe_vector_ccf(:,1),probe_vector_ccf(:,2),probe_vector_ccf(:,3), ...
            'color',probe_color(curr_animal,:),'linewidth',2);
        line(sagittal_axes,probe_vector_ccf(:,1),probe_vector_ccf(:,2), ...
            'color',probe_color(curr_animal,:),'linewidth',2);
        line(horizontal_axes,probe_vector_ccf(:,1),probe_vector_ccf(:,3), ...
            'color',probe_color(curr_animal,:),'linewidth',2);
        line(coronal_axes,probe_vector_ccf(:,3),probe_vector_ccf(:,2), ...
            'color',probe_color(curr_animal,:),'linewidth',2);
