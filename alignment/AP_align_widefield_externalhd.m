function im_aligned = AP_align_widefield_externalhd(im_unaligned,animal,day,align_type,master_align)
% im_aligned = AP_align_widefield_externalhd(im_unaligned,animal,day,align_type,master_align)
%
