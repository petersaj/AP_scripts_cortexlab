...
animal = 'AP110'; % animal name
day = '2022-01-27'; % yyyy-mm-dd
...
% V_blue_exp = mat2cell(V_blue,n_cam_blue + [0;size(V_blue,1)-sum(n_cam_blue);0;0],size(V_blue,2));
% V_purple_exp = mat2cell(V_purple,n_cam_purple + [0;size(V_purple,1)-sum(n_cam_purple);0;0],size(V_purple,2));
...
for curr_exp_idx = 1:length(experiments)
    ...
    disp(['Experiment ' num2str(experiments(curr_exp_idx)) ': saved manually parsed V''s and timestamps']);
