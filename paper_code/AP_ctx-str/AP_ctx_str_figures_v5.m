...
%% Fig 2(**pre-d:re-letter) Ternary plot for map-template correlations
...
%% ** Fig 3a-e, SFig5,6,7ab: Striatal domain activity and task regression
...
%% SFig4h: Latency between VisAM and DMS spikes
...
%% ** SFig6: Task > cortex kernels (go cue)
