...
%% Fig 1g-h: Task -> striatum unit regression (example and summary histogram)
...
%% Fig 1x: Striatal unit regression examples
...
%% Fig 4x: Striatum measured and cortex-predicted error by condition
