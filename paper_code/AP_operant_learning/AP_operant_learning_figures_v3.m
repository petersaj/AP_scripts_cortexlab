...
%% >> [FIG 4A] task ROI timecourse by learned day
...
%% >> [FIG 4C] task hemidiff ROI average daysplit by learned day
...
%% ++ [FIG 4A,C] passive - ROI timecourse/stim window by learned day
...
%% >>++ [FIG 4C - COMBINED]: combine task & passive daysplit (run 4C plots made first)
