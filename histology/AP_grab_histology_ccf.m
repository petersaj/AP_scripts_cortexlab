    ...
    case 'escape'
        ...
        if strcmp(user_confirm,'Yes')           
            ...
            histology_ccf = struct( ...
                ...
                'plane_x',histology_ccf_init, ...
                'plane_y',histology_ccf_init, ...
                'plane_z',histology_ccf_init);
            ...
            for curr_slice = 1:length(gui_data.slice_im)
                ...
                [histology_ccf(curr_slice).tv_slices, ...
                    ...
                    histology_ccf(curr_slice).plane_x, ...
                    histology_ccf(curr_slice).plane_y, ...
                    histology_ccf(curr_slice).plane_z] = ...
