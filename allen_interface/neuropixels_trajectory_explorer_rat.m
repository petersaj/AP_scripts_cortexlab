...
%
% IN PROGRESS: RAT VERSION USING WHS RAT ATLAS
...
if nargin < 3
    ...
    % Load CCF components
    tv = niftiread([atlas_path filesep 'WHS_SD_rat_T2star_v1.01.nii.gz']);
    av = niftiread([atlas_path filesep 'WHS_SD_rat_FA_color_v1.01.nii.gz']);
end
