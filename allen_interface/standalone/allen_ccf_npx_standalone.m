function allen_ccf_npx_standalone
% allen_ccf_npx
% Andy Peters (peters.andrew.j@gmail.com)
%
% GUI for planning Neuropixels trajectories with the Allen CCF
% (standalone version used for MATLAB-independent deployment)
...
st = loadStructureTree([allen_ccf_path filesep 'structure_tree_safe_2017.csv']); % a table of what all the labels mean
