function AP_stimWheelLeftReverse(t, events, parameters, visStim, inputs, outputs, audio)
% 2021-03-09 - AP
%
...
%
% REVERSE VERSION: wheel control is reversed from traditional (leftward
% turns make the stimulus move rightward)
...
% (Reverse version: direction of wheel control is reversed)
