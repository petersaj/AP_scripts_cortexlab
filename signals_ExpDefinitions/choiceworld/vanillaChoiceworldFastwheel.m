function vanillaChoiceworldFastwheel(t, events, parameters, visStim, inputs, outputs, audio)
...
% 191004 Created: 
% Made because all mice sitting still doing nothing for weeks
% Doubled wheel gain (IBL standard in beginning)
% Added +2ul to reward
% If this works, build into regular vanillaChoiceworld
% and delete this one
