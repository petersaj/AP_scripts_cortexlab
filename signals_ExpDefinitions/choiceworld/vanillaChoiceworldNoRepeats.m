function vanillaChoiceworldNoRepeats(t, events, parameters, visStim, inputs, outputs, audio)
% vanillaChoiceworldNoRepeats(t, events, parameters, visStim, inputs, outputs, audio)
% 
% vanillaChoiceworld with no repeat on incorrects (which normally happens
% with 50% and 100% contrasts) - used for manipulation experiments where
% bias is expected
%
% Task structure: 
% Start trial
...
repeatOnMiss = [false,false,false,false,false,false];
