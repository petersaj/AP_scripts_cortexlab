...
for curr_area_idx = 1:length(plot_areas)
    ...
    for curr_timeavg = 1:length(timeavg_labels)
        ...
        subplot(length(plot_areas),length(timeavg_labels) + 1, ...
    ...
    % Add explained variance to end plot 
    subplot(length(plot_areas),length(timeavg_labels) + 1, ...
        sub2ind(fliplr([length(plot_areas),length(timeavg_labels) + 1]),length(timeavg_labels)+1,curr_area_idx));
    hold on;
    errorbar( ...
