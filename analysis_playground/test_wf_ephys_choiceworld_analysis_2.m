...
curr_act_taskpred_allcat = mua_taskpred_allcat;
...
for curr_area = 1:length(plot_areas)
    ...
    trial_conditions = trial_condition_groups{curr_area};
        ...
        for curr_group = 1:length(group_labels)
            ...
            curr_act_taskpred_avg = cellfun(@(x) squeeze(nanmean(x(:,curr_event_t,:),2)),curr_act_taskpred,'uni',false);
            ...
            act_taskpred_binmean = cell2mat(arrayfun(@(condition) ...
                ...
                act(use_trials(:,area) & trial_cond(:,condition),area), ...
                [n_act_bins,1],@nanmean,single(NaN)), 1:size(act,2),'uni',false)), ...
                curr_act_taskpred_avg,trial_bins,trial_conditions_exp,nonan_trials,'uni',false),[2,3,1])), ...
                permute(1:size(trial_conditions,2),[1,3,4,2]),'uni',false));
            ...
            act_taskpred_totalmean = cell2mat(arrayfun(@(condition) ...
                cell2mat(permute(cellfun(@(act,bins,trial_cond,use_trials) cell2mat(arrayfun(@(area) ...
                accumarray(bins(use_trials(:,area) & trial_cond(:,condition),area), ...
                act(use_trials(:,area) & trial_cond(:,condition),area), ...
                [n_act_bins,1],@nanmean,single(NaN)), 1:size(act,2),'uni',false)), ...
                curr_act_taskpred_avg,total_bins,trial_conditions_exp,nonan_trials,'uni',false),[2,3,1])), ...
                permute(1:size(trial_conditions,2),[1,3,4,2]),'uni',false));
            ...
            errorbar( ...
                ...
                squeeze(nanmean(act_taskpred_binmean(:,plot_area,:,:),3)), ...
                squeeze(AP_sem(act_taskpred_binmean(:,plot_area,:,:),3)),'linewidth',2);           
            errorbar( ...
                squeeze(nanmean(act_totalmean(:,plot_area,:,:),3)), ...
                squeeze(nanmean(act_taskpred_totalmean(:,plot_area,:,:),3)), ...
                squeeze(AP_sem(act_taskpred_totalmean(:,plot_area,:,:),3)),'linewidth',2);
