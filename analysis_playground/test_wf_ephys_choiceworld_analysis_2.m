...
%             curr_ctx_act_allcat = fluor_roi_deconv - curr_ctx_act_reduced;
            ...
            errorbar( ...
                ...
                squeeze(AP_sem(str_act_totalmean(:,plot_str,:,:),3)),'linewidth',3);
    ...
    trial_conditions = trial_condition_groups{curr_area};
        ...
        for curr_timeavg = 1:length(timeavg_labels)
            ...
            errorbar( ...
                ...
                squeeze(AP_sem(act_pred_binmean(:,plot_area,:,:),3)),'linewidth',2);           
            errorbar( ...
                squeeze(nanmean(act_totalmean(:,plot_area,:,:),3)), ...
                squeeze(nanmean(act_pred_totalmean(:,plot_area,:,:),3)), ...
                squeeze(AP_sem(act_pred_totalmean(:,plot_area,:,:),3)),'linewidth',3);
