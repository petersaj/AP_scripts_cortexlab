...
plot_cells = stim_cells & ismember(celltype_allcat,[1]) & domain_aligned_allcat == 1;
...
ctx_str_k_px_downsamp = imresize(ctx_str_k_px,downsamp_factor,'bilinear'); 
y = tsne(reshape(ctx_str_k_px,[],size(ctx_str_k_px,3)'),'Distance','correlation');
