...
% Load data
data_path = ['C:\Users\Andrew\OneDrive for Business\Documents\CarandiniHarrisLab\analysis\wf_ephys_choiceworld\choiceworld'];
data_fn = ['activity_sessioncat_logistic_regression_latemove_kernel-str_' num2str(n_aligned_depths) '_depths.mat'];
...
%% Distribution plots of time-averaged day-concatenated activity (move L/R)
